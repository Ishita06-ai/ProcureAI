...
export const api = {
  ...
  approvePO:  (id, comment) => request(`/purchase-orders/${id}/approve`, { method: 'POST', body: { comment } }),
  rejectPO:   (id, comment) => request(`/purchase-orders/${id}/reject`,  { method: 'POST', body: { comment } }),
  ...
  analyticsApprovalSla:     () => request('/analytics/approval-sla'),
  ...
  updateWorkspace: (data) => request('/workspace', { method: 'PATCH', body: data }),
};
